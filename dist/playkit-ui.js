...
var _playPause = __webpack_require__(84);
...
var _fullscreen = __webpack_require__(104);
...
var _bottomBar = __webpack_require__(108);
...
var _overlayAction = __webpack_require__(64);

var _overlayAction2 = _interopRequireDefault(_overlayAction);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = _overlayAction2.default;
...
exports.default = function () {
  ...
  switch (action.type) {
    ...
    case types.UPDATE_COMPONENT:
      {
        return _extends({}, state, {
          components: _extends({}, state.components, _defineProperty({}, action.componentAlias, _playkitJs.Utils.Object.mergeDeep(state.components[action.componentAlias], action.config)))
        });
      }
    default:
      return state;
...
var _language = __webpack_require__(98);
...
var _timeDisplay = __webpack_require__(107);
...
var _overlayPortal = __webpack_require__(109);
...
var _unmuteIndication = __webpack_require__(110);
...
var _prePlaybackPlayOverlay = __webpack_require__(23);
...
var _timeDisplayPlaybackContainer = __webpack_require__(105);

var _timeDisplayPlaybackContainer2 = _interopRequireDefault(_timeDisplayPlaybackContainer);

var _bottomBar = __webpack_require__(18);
...
var _watermark = __webpack_require__(139);

var _watermark2 = _interopRequireDefault(_watermark);

var _componentConfig = __webpack_require__(19);
...
function playbackUI(props) {
  return (0, _preact.h)(
    ...
    (0, _preact.h)(
      ...
      (0, _preact.h)(_overlayAction2.default, { player: props.player }),
      (0, _preact.h)(
        _bottomBar2.default,
        null,
    ...
    (0, _componentConfig.shouldRenderComponent)(props.config, _watermark2.default.displayName) ? (0, _preact.h)(_watermark2.default, { player: props.player }) : undefined
  );
}
...
var actions = exports.actions = {
  ...
  updateSettingsMenuOpen: function updateSettingsMenuOpen(menuOpen) {
    return { type: types.UPDATE_MENU_OPEN, menuOpen: menuOpen };
  }
};
...
var actions = exports.actions = {
  updateLanguageMenuOpen: function updateLanguageMenuOpen(menuOpen) {
    return { type: types.UPDATE_MENU_OPEN, menuOpen: menuOpen };
  }
};
...
var _overlayAction = __webpack_require__(22);
...
var _shell2 = __webpack_require__(52);
  ...
  _createClass(Shell, [{
    ...
    value: function componentDidMount() {
      ...
      window.addEventListener('resize', function () {
        var playerContainer = document.getElementById(_this2.props.targetId);
        if (playerContainer) {
          _this2.props.updatePlayerClientRect(playerContainer.getBoundingClientRect());
        }
        if (document.body) {
      ...
      this.player.addEventListener(this.player.Event.FIRST_PLAY, function () {
        _this2._updatePlayerHoverState();
      });
    }
    ...
    value: function _canEndHoverState() {
      return !this.props.seekbarDraggingActive && !this.props.seekbarHoverActive && !this.props.volumeHoverActive && !this.props.languageMenuOpen && !this.props.settingsMenuOpen;
    }
...
var _timeDisplayAdsContainer = __webpack_require__(113);

var _timeDisplayAdsContainer2 = _interopRequireDefault(_timeDisplayAdsContainer);

var _adSkip = __webpack_require__(115);

var _adSkip2 = _interopRequireDefault(_adSkip);

var _adLearnMore = __webpack_require__(117);
  ...
  return (0, _preact.h)(
    ...
    (0, _preact.h)(
      ...
      (0, _preact.h)(
        _bottomBar2.default,
        null,
        (0, _preact.h)(_seekbarAdsContainer2.default, {
          adBreak: true,
...
var _topBar = __webpack_require__(119);
...
var _seekbarLivePlaybackContainer = __webpack_require__(120);
...
var _liveTag = __webpack_require__(122);
  ...
  return (0, _preact.h)(
    ...
    (0, _preact.h)(
      ...
      (0, _preact.h)(
        _bottomBar2.default,
        null,
        (0, _preact.h)(_seekbarLivePlaybackContainer2.default, {
          showFramePreview: true,
          showTimeBubble: true,
          player: props.player,
          playerContainer: props.playerContainer }),
...
var _errorOverlay = __webpack_require__(57);
...
function errorUI(props) {
  return (0, _preact.h)(
    'div',
    { className: _style2.default.playbackGuiWWrapper },
    (0, _preact.h)(_errorOverlay2.default, { player: props.player })
  );
}
...
var _errorOverlay = __webpack_require__(124);
...
exports.NAME = exports.VERSION = exports.UIManager = exports.ErrorOverlay = exports.KeyboardControl = exports.OverlayPortal = exports.BottomBar = exports.TopBar = exports.TimeDisplay = exports.FullscreenControl = exports.LanguageControl = exports.SettingsControl = exports.ShareControl = exports.VolumeControl = exports.SeekBarControl = exports.PlayPauseControl = exports.Loading = exports.PrePlaybackPlayOverlay = exports.OverlayAction = exports.errorUI = exports.liveUI = exports.adsUI = exports.playbackUI = exports.h = undefined;
...
var _ads = __webpack_require__(53);
...
var _live = __webpack_require__(55);
...
var _uiManager = __webpack_require__(129);
 ...
 * @extends {BaseComponent}
 */
var OverlayAction = (_dec = (0, _preactRedux.connect)(mapStateToProps, (0, _bindActions.bindActions)(_overlayAction.actions)), _dec(_class = function (_BaseComponent) {
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(21), __webpack_require__(75)(module)))
  ...
  _createClass(Loading, [{
    ...
    value: function componentDidMount() {
      ...
      this.player.addEventListener(this.player.Event.PLAYER_STATE_CHANGED, function (e) {
        ...
        if (!_this2.state.afterPlayingEvent) {
          return;
        }
      ...
      this.player.addEventListener(this.player.Event.SOURCE_SELECTED, function () {
        if (_this2.player.config.autoplay) {
          _this2.props.updateLoadingSpinnerState(true);
        }
      });
...
var _preactI18n = __webpack_require__(7);

var _preactRedux = __webpack_require__(2);

var _bindActions = __webpack_require__(4);

var _playPause = __webpack_require__(44);
...
var _rewind = __webpack_require__(87);
...
var _seekbarPlaybackContainer = __webpack_require__(89);
...
var _timeFormat = __webpack_require__(25);
    ...
    value: function render(props) {
      ...
      return (0, _preact.h)(
        'div',
        {
          ...
          onMouseOver: function onMouseOver() {
            return _this5.props.updateSeekbarHoverActive(true);
          },
          onMouseLeave: function onMouseLeave() {
            return _this5.props.updateSeekbarHoverActive(false);
          },
    ...
    value: function render() {
      ...
      return (0, _preact.h)(
        'div',
        {
          ...
          onMouseOver: function onMouseOver() {
            _this3.props.updateVolumeHover(true);
            _this3.setState({ hover: true });
          },
          onMouseOut: function onMouseOut() {
            _this3.props.updateVolumeHover(false);
            _this3.setState({ hover: false });
          } },
        (0, _preact.h)(
          'button',
...
var _cvaaOverlay = __webpack_require__(99);
 ...
 * @extends {BaseComponent}
 */
var LanguageControl = (_dec = (0, _preactRedux.connect)(mapStateToProps, (0, _bindActions.bindActions)(Object.assign(_language.actions, _cvaa.actions))), _dec(_class = function (_BaseComponent) {
  ...
  _createClass(FullscreenControl, [{
    ...
    value: function enterFullscreen() {
      if (this.props.isMobile && this.player.env.os.name === 'iOS') {
        ...
        var elementToFullscreen = document.getElementById(this.props.targetId);
...
var _timeDisplayPlaybackContainer = __webpack_require__(106);
    ...
    value: function render(props) {
      ...
      return (0, _preact.h)(
        ...
        { className: _style2.default.bottomBar,
          onMouseOver: function onMouseOver() {
            _this2.props.updateBottomBarHoverActive(true);
            _this2.props.updatePlayerHoverState(true);
          },
          onMouseLeave: function onMouseLeave() {
...
var _seekbarAdsContainer = __webpack_require__(112);
  ...
  _createClass(SeekBarAdsContainer, [{
    ...
    value: function render(props) {
      ...
      return (0, _preact.h)(_seekbar3.default, {
        ...
        updateSeekbarHoverActive: function updateSeekbarHoverActive(data) {
          return _this2.props.updateSeekbarHoverActive(data);
        },
...
var _timeDisplayAdsContainer = __webpack_require__(114);
...
var _adSkip = __webpack_require__(116);
...
var _adLearnMore = __webpack_require__(118);
...
var _seekbarLivePlaybackContainer = __webpack_require__(121);
...
var _liveTag = __webpack_require__(123);
...
var _share = __webpack_require__(126);
...
var _shareOverlay = __webpack_require__(127);
...
var _shareOverlay = __webpack_require__(128);
...
var _fr = __webpack_require__(131);
...
var _engineConnector = __webpack_require__(132);

var _engineConnector2 = _interopRequireDefault(_engineConnector);

var _shell = __webpack_require__(134);

var _shell2 = _interopRequireDefault(_shell);

var _videoPlayer = __webpack_require__(135);

var _videoPlayer2 = _interopRequireDefault(_videoPlayer);

var _playerGui = __webpack_require__(137);
...
var _engineConnector = __webpack_require__(133);
...
var _videoPlayer = __webpack_require__(136);
