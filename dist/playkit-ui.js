...
var _playkitJs = __webpack_require__(27);
...
var _bottomBar = __webpack_require__(139);
...
var _unmuteIndication = __webpack_require__(141);
...
var _jsLogger = __webpack_require__(93);
...
var EventType = {
  ...
  USER_CLICKED_STEREO_MODE: namespace + '-userclickedstereomode',
...
var _componentConfig = __webpack_require__(16);
...
var _overlayAction = __webpack_require__(30);
...
var _shell2 = __webpack_require__(56);
...
var _timeDisplay = __webpack_require__(138);
...
var _overlayPortal = __webpack_require__(140);
...
var _audioSelectedEvent = __webpack_require__(97);

var _captionSelectedEvent = __webpack_require__(98);

var _captionsStyleSelectedEvent = __webpack_require__(99);

var _qualitySelectedEvent = __webpack_require__(100);

var _seekedEvent = __webpack_require__(101);

var _speedSelectedEvent = __webpack_require__(102);

var _uiVisibilityChangedEvent = __webpack_require__(103);

var _rewindClicked = __webpack_require__(104);

var _volumeChanged = __webpack_require__(105);

var _pointerDown = __webpack_require__(106);
...
function onClickableComponentsHandler(store, action, player) {
  switch (action.name) {
    ...
    case 'Stereo':
      player.dispatchEvent(new _fakeEvent.FakeEvent(_fakeEvent.FakeEvent.Type.USER_CLICKED_STEREO_MODE));
      break;
  }
}
...
function onOverlayActionClicked(store, action, player) {
  switch (action.payload.type) {
    ...
    case 'PointerDown':
      player.dispatchEvent(new _pointerDown.PointerDownEvent(action.payload));
      break;
...
var _ads = __webpack_require__(142);
...
var _live = __webpack_require__(149);
...
var _timeDisplayPlaybackContainer = __webpack_require__(137);
...
var _timeDisplayAdsContainer = __webpack_require__(143);
...
var _adSkip = __webpack_require__(144);
...
var _adLearnMore = __webpack_require__(145);
...
var _topBar = __webpack_require__(146);
...
var _errorOverlay = __webpack_require__(148);
...
var _seekbarLivePlaybackContainer = __webpack_require__(150);
...
var _liveTag = __webpack_require__(151);
...
var _shareOverlay = __webpack_require__(157);
...
exports.NAME = exports.VERSION = exports.UIManager = exports.EventType = exports.Utils = exports.Components = exports.Presets = exports.redux = exports.preact = exports.h = undefined;
...
var _uiManager = __webpack_require__(75);
...
var _uiPresets = __webpack_require__(58);

var Presets = _interopRequireWildcard(_uiPresets);

var _components = __webpack_require__(154);
...
var _copyDeep = __webpack_require__(92);
...
var _engineConnector = __webpack_require__(53);

var _shell = __webpack_require__(55);
...
var _middlewares = __webpack_require__(152);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(23), __webpack_require__(86)(module)))
...
var _volume = __webpack_require__(49);
...
var _stereo = __webpack_require__(136);
...
var EngineConnector = (_dec = (0, _preactRedux.connect)(_engine2.default, (0, _bindActions.bindActions)(_engine.actions)), _dec(_class = function (_BaseComponent) {
  ...
  _createClass(EngineConnector, [{
    ...
    value: function componentDidMount() {
      ...
      this.player.addEventListener(this.player.Event.PLAYER_RESET, function () {
        _this2.props.updateIsIdle(true);
      });

      this.player.addEventListener(this.player.Event.SOURCE_SELECTED, function () {
      ...
      this.player.addEventListener(this.player.Event.AD_ERROR, function (e) {
        if (e.payload.fatal) {
          _this2.props.updateAdBreak(false);
        }
      });
...
exports.PointerDownEvent = undefined;
 ...
 * @extends {FakeEvent}
 */
var PointerDownEvent = function (_FakeEvent) {
  _inherits(PointerDownEvent, _FakeEvent);
   ...
   */
  function PointerDownEvent(coordinates) {
    _classCallCheck(this, PointerDownEvent);

    var _this = _possibleConstructorReturn(this, (PointerDownEvent.__proto__ || Object.getPrototypeOf(PointerDownEvent)).call(this, _fakeEvent.FakeEvent.Type.USER_POINTER_DOWN));
...
exports.locals = {
	...
	"icon-stereo": "playkit-icon-stereo",
	"iconStereo": "playkit-icon-stereo",
	"icon-stereo-full": "playkit-icon-stereo-full",
	"iconStereoFull": "playkit-icon-stereo-full",
	...
	"control-stereo": "playkit-control-stereo",
	"controlStereo": "playkit-control-stereo",
	"stereo-mode": "playkit-stereo-mode",
	"stereoMode": "playkit-stereo-mode"
};
...
var Loading = (_dec = (0, _preactRedux.connect)(mapStateToProps, (0, _bindActions.bindActions)(_loading.actions)), _dec(_class = function (_BaseComponent) {
  ...
  _createClass(Loading, [{
    ...
    value: function componentDidMount() {
      ...
      this.player.addEventListener(this.player.Event.PLAYING, function () {
...
var _overlayAction = __webpack_require__(31);

var _prePlaybackPlayOverlay = __webpack_require__(32);

var _loading = __webpack_require__(12);

var _playPause = __webpack_require__(17);

var _rewind = __webpack_require__(59);

var _seekbarPlaybackContainer = __webpack_require__(60);
...
var _stereo = __webpack_require__(134);

var _timeDisplayPlaybackContainer = __webpack_require__(65);

var _bottomBar = __webpack_require__(20);

var _overlayPortal = __webpack_require__(42);

var _keyboard = __webpack_require__(21);

var _unmuteIndication = __webpack_require__(22);

var _watermark = __webpack_require__(43);
    ...
    (0, _preact.h)(
      ...
      (0, _preact.h)(
        ...
        (0, _preact.h)(
          ...
          props.state.engine.isVr && (0, _componentConfig.shouldRenderComponent)(props.config, _stereo.StereoControl.displayName) ? (0, _preact.h)(_stereo.StereoControl, null) : undefined,
    ...
    value: function render(props) {
      switch (props.type) {
        ...
        case IconType.Stereo:
          return (0, _preact.h)('i', { className: [_style2.default.icon, _style2.default.iconStereo].join(' ') });

        case IconType.StereoFull:
          return (0, _preact.h)('i', { className: [_style2.default.icon, _style2.default.iconStereoFull].join(' ') });
...
var _timeFormat = __webpack_require__(34);
...
var _smartContainer = __webpack_require__(37);

var _smartContainerItem = __webpack_require__(61);
...
var _preactPortal = __webpack_require__(38);
...
var _cvaaOverlay = __webpack_require__(63);
...
var FullscreenControl = (_dec = (0, _preactRedux.connect)(mapStateToProps, (0, _bindActions.bindActions)(Object.assign(_shell.actions, _fullscreen.actions))), _dec(_class = function (_BaseComponent) {
  ...
  function FullscreenControl(obj) {
    ...
    _this.fullscreenChangeHandler = (0, _bindMethod.bindMethod)(_this, _this.fullscreenChangeHandler);
    return _this;
  }
    ...
    value: function handleIosFullscreen() {
      ...
      if (this.player.env.os.name === 'iOS') {
        ...
        var attachIosFullscreenListeners = function attachIosFullscreenListeners() {
          _this3.player.removeEventListener(_this3.player.Event.SOURCE_SELECTED, attachIosFullscreenListeners);
          _this3.player.getVideoElement().addEventListener('webkitbeginfullscreen', function () {
            return _this3.fullscreenEnterHandler();
          });
          _this3.player.getVideoElement().addEventListener('webkitendfullscreen', function () {
...
var _stereo = __webpack_require__(135);

Object.defineProperty(exports, 'StereoControl', {
  enumerable: true,
  get: function get() {
    return _stereo.StereoControl;
  }
});
...
exports.StereoControl = undefined;
 ...
 * @extends {BaseComponent}
 */
var StereoControl = (_dec = (0, _preactRedux.connect)(mapStateToProps, (0, _bindActions.bindActions)(Object.assign({}, _shell.actions, _stereo.actions))), _dec(_class = function (_BaseComponent) {
  _inherits(StereoControl, _BaseComponent);
  ...
  function StereoControl() {
    _classCallCheck(this, StereoControl);

    return _possibleConstructorReturn(this, (StereoControl.__proto__ || Object.getPrototypeOf(StereoControl)).call(this, { name: 'Stereo' }));
  }
  ...
  _createClass(StereoControl, [{
    ...
    value: function render() {
      ...
      return (0, _preact.h)(
        'div',
        { className: [_style2.default.controlButtonContainer, _style2.default.controlStereo].join(' ') },
        (0, _preact.h)(
          _preactI18n.Localizer,
          null,
          (0, _preact.h)(
            ...
            {
              tabIndex: '0',
              'aria-label': (0, _preact.h)(_preactI18n.Text, { id: 'controls.stereo' }),
              className: this.props.stereoMode ? [_style2.default.controlButton, _style2.default.stereoMode].join(' ') : _style2.default.controlButton,
              onClick: function onClick() {
                return _this2.onClick();
              },
              onKeyDown: function onKeyDown(e) {
            ...
            (0, _preact.h)(_icon2.default, { type: _icon.IconType.Stereo }),
            (0, _preact.h)(_icon2.default, { type: _icon.IconType.StereoFull })
          )
        )
      );
    }
  ...
  return StereoControl;
}(_base2.default)) || _class);
StereoControl.displayName = 'stereo';
exports.StereoControl = StereoControl;
...
var actions = exports.actions = {
  updateStereoMode: function updateStereoMode(stereoMode) {
    return { type: types.UPDATE_STEREO_MODE, stereoMode: stereoMode };
  }
};
...
var _timeDisplay = __webpack_require__(41);
...
var _timeDisplayAdsContainer = __webpack_require__(66);

var _adSkip = __webpack_require__(67);

var _adLearnMore = __webpack_require__(68);
...
var _errorOverlay = __webpack_require__(70);
...
var _seekbarLivePlaybackContainer = __webpack_require__(71);
...
var _liveTag = __webpack_require__(72);
...
var _logger = __webpack_require__(153);
...
var _seekbar = __webpack_require__(33);
...
var _shareOverlay = __webpack_require__(73);
...
var _watermark = __webpack_require__(160);
...
var _share = __webpack_require__(156);
