...
var _overlayAction = __webpack_require__(168);
...
exports.KeyboardControl = exports.OverlayPortal = exports.BottomBar = exports.TopBar = exports.TimeDisplay = exports.FullscreenControl = exports.LanguageControl = exports.SettingsControl = exports.ShareControl = exports.VolumeControl = exports.SeekBarControl = exports.PlayPauseControl = exports.Loading = exports.PrePlaybackPlayOverlay = exports.Bezel = exports.liveUI = exports.adsUI = exports.playbackUI = exports.h = undefined;
...
var Loading = (_dec = (0, _preactRedux.connect)(mapStateToProps, (0, _bindActions.bindActions)(_loading3.actions)), _dec(_class = function (_BaseComponent) {
  ...
  function Loading(obj) {
    ...
    _this.setState({ afterFirstPlay: false });
    try {
  ...
  _createClass(Loading, [{
    ...
    value: function componentDidMount() {
      ...
      this.player.addEventListener(this.player.Event.PLAYER_STATE_CHANGED, function (e) {
        if (!_this2.state.afterFirstPlay) {
          return;
        }
...
var _overlayAction = __webpack_require__(172);
...
var _shell2 = __webpack_require__(155);
...
var _overlayAction = __webpack_require__(173);
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../node_modules/css-loader/index.js??ref--2-1!../../../node_modules/sass-loader/lib/loader.js!./_overlay-action.scss", function() {
			var newContent = require("!!../../../node_modules/css-loader/index.js??ref--2-1!../../../node_modules/sass-loader/lib/loader.js!./_overlay-action.scss");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
// module
exports.push([module.i, "@keyframes playkit-overlayActionIconIn {\n  0% {\n    opacity: 0;\n    transform: scale(0); }\n  10% {\n    opacity: 0.1;\n    transform: scale(0.1); }\n  20% {\n    opacity: 0.3;\n    transform: scale(0.2); }\n  30% {\n    opacity: 0.5;\n    transform: scale(0.3); }\n  40% {\n    opacity: 0.7;\n    transform: scale(0.4); }\n  50% {\n    opacity: 0.9;\n    transform: scale(0.5); }\n  60% {\n    opacity: 0.9;\n    transform: scale(0.5); }\n  70% {\n    opacity: 0.9;\n    transform: scale(0.5); }\n  75% {\n    opacity: 0.9;\n    transform: scale(0.5); }\n  80% {\n    opacity: 1;\n    transform: scale(0.5); }\n  85% {\n    opacity: 1;\n    transform: scale(0.5); }\n  90% {\n    opacity: 1;\n    transform: scale(0.5); }\n  93% {\n    opacity: 0.7;\n    transform: scale(0.5); }\n  95% {\n    opacity: 0.5;\n    transform: scale(0.5); }\n  98% {\n    opacity: 0.2;\n    transform: scale(0.5); }\n  100% {\n    opacity: 0.0;\n    transform: scale(0.5); } }\n\n.playkit-overlay-action {\n  position: absolute;\n  top: 0;\n  left: 0;\n  width: 100%;\n  height: 100%; }\n  .playkit-overlay-action.playkit-in .playkit-icon {\n    animation: playkit-overlayActionIconIn 300ms linear forwards; }\n  .playkit-overlay-action .playkit-icon {\n    width: 144px;\n    height: 144px;\n    position: absolute;\n    top: 50%;\n    left: 50%;\n    margin: -72px 0 0 -72px;\n    opacity: 0; }\n", ""]);
...
var _overlayAction = __webpack_require__(170);
...
var _overlayAction3 = __webpack_require__(172);
 ...
 * @extends {BaseComponent}
 */
var OverlayAction = (_dec = (0, _preactRedux.connect)(mapStateToProps, (0, _bindActions.bindActions)(_overlayAction3.actions)), _dec(_class = function (_BaseComponent) {
  ...
  _createClass(OverlayAction, [{
    ...
    value: function render() {
      ...
      return (0, _preact.h)(
        'div',
        { className: _overlayAction2.default.overlayAction + ' ' + (this.state.animation ? _overlayAction2.default.in : ''),
          onClick: function onClick() {
    ...
    value: function renderIcons() {
      if (Array.isArray(this.state.iconType)) {
        return this.state.iconType.map(function (i) {
          return (0, _preact.h)(_icon2.default, { type: i });
        });
      }
