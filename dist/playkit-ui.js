...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_redux__ = __webpack_require__(13);
...
var _eventDispatcher = __webpack_require__(55);

var _eventManager = __webpack_require__(162);
...
var BaseComponent = function (_Component) {
  ...
  function BaseComponent() {
    ...
    _this.eventManager = new _eventManager.EventManager();
...
var _eventType = __webpack_require__(29);
...
var _componentConfig = __webpack_require__(14);
...
var _mergeDeep = __webpack_require__(161);
...
function getComponentStateFromConfig(component, oldState, action) {
  ...
  if (componentConfig) {
    return (0, _mergeDeep.mergeDeep)(oldState, componentConfig);
  }
  return oldState;
}
...
function getComponentStateFromComponentConfig(component, oldState, action) {
  if (action.componentAlias === component) {
    return (0, _mergeDeep.mergeDeep)(oldState, action.config);
  }
  return oldState;
}
...
var _overlay = __webpack_require__(126);
...
var _playPause = __webpack_require__(119);
...
var _bottomBar = __webpack_require__(137);
...
var _keyboard = __webpack_require__(39);
...
var _unmuteIndication = __webpack_require__(139);
...
var _jsLogger = __webpack_require__(94);
...
var _overlayAction = __webpack_require__(116);
...
var _prePlaybackPlayOverlay = __webpack_require__(118);
...
var _seekbar = __webpack_require__(122);
...
var _overlayAction = __webpack_require__(20);

var _bindActions = __webpack_require__(4);

var _keyMap = __webpack_require__(6);

var _icon = __webpack_require__(5);

var _shell2 = __webpack_require__(57);
...
var _smartContainer = __webpack_require__(125);
...
var _language = __webpack_require__(129);
...
var _vrStereoToggle = __webpack_require__(134);
...
var _timeDisplay = __webpack_require__(136);
...
var _overlayPortal = __webpack_require__(138);
  ...
  _createClass(Watermark, [{
    ...
    value: function componentDidMount() {
      ...
      var onPlaying = function onPlaying() {
        _this2.player.removeEventListener(_this2.player.Event.PLAYING, onPlaying);
      ...
      this.player.addEventListener(this.player.Event.CHANGE_SOURCE_ENDED, function () {
        ...
        _this2.player.addEventListener(_this2.player.Event.PLAYING, onPlaying);
      });
    }
...
var _fakeEvent = __webpack_require__(9);

var _shell = __webpack_require__(7);

var _audioSelectedEvent = __webpack_require__(98);

var _captionSelectedEvent = __webpack_require__(99);

var _captionsStyleSelectedEvent = __webpack_require__(100);

var _qualitySelectedEvent = __webpack_require__(101);

var _seekedEvent = __webpack_require__(102);

var _speedSelectedEvent = __webpack_require__(103);

var _uiVisibilityChangedEvent = __webpack_require__(104);

var _rewindClicked = __webpack_require__(105);

var _volumeChanged = __webpack_require__(106);
...
var _bindMethod = __webpack_require__(10);
      ...
      return (0, _preact.h)(
        'div',
        {
          ...
          onMouseLeave: function onMouseLeave(event) {
            return _this3.onMouseLeave(event);
          },
...
var _videoPlayer = __webpack_require__(111);
...
var _idle = __webpack_require__(113);
...
var _playback = __webpack_require__(115);
...
var _ads = __webpack_require__(140);
...
var _rewind = __webpack_require__(120);
...
var _seekbarPlaybackContainer = __webpack_require__(121);
...
var _cvaaOverlay = __webpack_require__(130);
...
var _timeDisplayPlaybackContainer = __webpack_require__(135);
...
var _timeDisplayAdsContainer = __webpack_require__(141);
...
var _adSkip = __webpack_require__(142);
...
var _adLearnMore = __webpack_require__(143);
...
var _topBar = __webpack_require__(144);
...
var _errorOverlay = __webpack_require__(146);
...
var _seekbarLivePlaybackContainer = __webpack_require__(148);
...
var _liveTag = __webpack_require__(149);
...
var _shareOverlay = __webpack_require__(156);
...
var _uiManager = __webpack_require__(76);
...
var _uiPresets = __webpack_require__(59);
...
var _copyDeep = __webpack_require__(93);
...
var _engineConnector = __webpack_require__(54);

var _shell = __webpack_require__(56);

var _videoPlayer = __webpack_require__(58);

var _playerGui = __webpack_require__(112);

var _uiPresets = __webpack_require__(59);

var presets = _interopRequireWildcard(_uiPresets);

var _middlewares = __webpack_require__(150);
  ...
  _createClass(UIManager, [{
        ...
        var template = (0, _preact.h)(
          ...
          (0, _preact.h)(
            ...
            (0, _preact.h)(
              ...
              (0, _preact.h)(_playerGui.PlayerGUI, { uis: uis, player: this.player, playerContainer: this.container })
            )
          )
        );

        // render the player
        this.root = (0, _preact.render)(template, this.container);
      }
    }
    ...
    value: function destroy() {
      if (this.container) {
        ...
        (0, _preact.render)('', this.container, this.root);
      }
    }
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(27), __webpack_require__(87)(module)))
...
var _cvaa = __webpack_require__(19);
 ...
 * @extends {BaseComponent}
 */
var EngineConnector = (_dec = (0, _preactRedux.connect)(_engine2.default, (0, _bindActions.bindActions)(_extends({}, _engine.actions, _loading.actions, _shell.actions))), _dec(_class = function (_BaseComponent) {
  ...
  _createClass(EngineConnector, [{
    ...
    value: function componentDidMount() {
      ...
      this.eventManager.listen(this.player, this.player.Event.PLAYER_RESET, function () {
      ...
      this.eventManager.listen(this.player, this.player.Event.SOURCE_SELECTED, function () {
        ...
        if (_this2.player.config.playback.autoplay) {
          ...
          _this2.props.updatePrePlayback(true);
          _this2.props.addPlayerClass(_style2.default.prePlayback);
        }
      });

      this.eventManager.listen(this.player, this.player.Event.CHANGE_SOURCE_STARTED, function () {
      ...
      this.eventManager.listen(this.player, this.player.Event.CHANGE_SOURCE_ENDED, function () {
        _this2.props.updatePlayerPoster(_this2.player.poster);
        _this2.props.updateIsIdle(false);
      });

      this.eventManager.listen(this.player, this.player.Event.PLAYER_STATE_CHANGED, function (e) {
      ...
      this.eventManager.listen(this.player, this.player.Event.DURATION_CHANGE, function () {
        _this2.props.updateDuration(_this2.player.duration);
      });

      this.eventManager.listen(this.player, this.player.Event.LOADED_DATA, function () {
        _this2.props.updateDuration(_this2.player.duration);
      });
      ...
      this.eventManager.listen(this.player, this.player.Event.TEXT_TRACK_CHANGED, function () {
        var tracks = _this2.player.getTracks(TrackType.TEXT);
        _this2.props.updateTextTracks(tracks);
      });

      this.eventManager.listen(this.player, this.player.Event.AUDIO_TRACK_CHANGED, function () {
        var tracks = _this2.player.getTracks(TrackType.AUDIO);
        _this2.props.updateAudioTracks(tracks);
      });

      this.eventManager.listen(this.player, this.player.Event.VIDEO_TRACK_CHANGED, function () {
        var tracks = _this2.player.getTracks(TrackType.VIDEO);
        _this2.props.updateVideoTracks(tracks);
      });

      this.eventManager.listen(this.player, this.player.Event.AD_BREAK_START, function () {
        _this2.props.updateHasError(false);
        _this2.props.updateAdBreak(true);
      });

      this.eventManager.listen(this.player, this.player.Event.AD_BREAK_END, function () {
        _this2.props.updateAdBreak(false);
      });

      this.eventManager.listen(this.player, this.player.Event.ALL_ADS_COMPLETED, function () {
        _this2.props.updateAdBreak(false);
      });

      this.eventManager.listen(this.player, this.player.Event.AD_PROGRESS, function (e) {
      ...
      this.eventManager.listen(this.player, this.player.Event.AD_COMPLETED, function () {
        _this2.props.updateAdBreakCompleted();
      });

      this.eventManager.listen(this.player, this.player.Event.AD_STARTED, function () {
        _this2.props.updateAdIsPlaying(true);
      });

      this.eventManager.listen(this.player, this.player.Event.AD_RESUMED, function () {
        _this2.props.updateAdIsPlaying(true);
      });

      this.eventManager.listen(this.player, this.player.Event.AD_PAUSED, function () {
        _this2.props.updateAdIsPlaying(false);
      });

      this.eventManager.listen(this.player, this.player.Event.AD_ERROR, function (e) {
        if (e.payload.fatal) {
          _this2.props.updateAdBreak(false);
        }
      });

      this.eventManager.listen(this.player, this.player.Event.FALLBACK_TO_MUTED_AUTOPLAY, function () {
        _this2.props.updateFallbackToMutedAutoPlay(true);
      });

      this.eventManager.listen(this.player, this.player.Event.AD_LOADED, function (e) {
      ...
      this.eventManager.listen(this.player, this.player.Event.VR_STEREO_MODE_CHANGED, function (e) {
        _this2.props.updateVrStereoMode(e.payload.mode);
      });

      this.eventManager.listen(this.player, this.player.Event.ERROR, function (e) {
...
var Loading = (_dec = (0, _preactRedux.connect)(mapStateToProps, (0, _bindActions.bindActions)(_loading.actions)), _dec(_class = function (_BaseComponent) {
  ...
  _createClass(Loading, [{
    ...
    value: function componentDidMount() {
      ...
      this.eventManager.listen(this.player, this.player.Event.AD_LOADED, function () {
        _this2.props.updateLoadingSpinnerState(true);
      });
      ...
      this.eventManager.listen(this.player, this.player.Event.AUTOPLAY_FAILED, function () {
        _this2.props.updateLoadingSpinnerState(false);
      });
...
var _overlayAction = __webpack_require__(35);

var _prePlaybackPlayOverlay = __webpack_require__(36);

var _loading = __webpack_require__(15);

var _playPause = __webpack_require__(21);

var _rewind = __webpack_require__(60);

var _seekbarPlaybackContainer = __webpack_require__(61);

var _volume = __webpack_require__(22);
...
var _vrStereoToggle = __webpack_require__(45);

var _timeDisplayPlaybackContainer = __webpack_require__(66);
...
var _unmuteIndication = __webpack_require__(26);

var _watermark = __webpack_require__(48);
  ...
  return (0, _preact.h)(
    ...
    (0, _preact.h)(
      ...
      (0, _preact.h)(
        ...
        null,
        (0, _preact.h)(_seekbarPlaybackContainer.SeekBarPlaybackContainer, { showFramePreview: true, showTimeBubble: true, player: props.player, playerContainer: props.playerContainer }),
        (0, _preact.h)(
          'div',
        ...
        (0, _preact.h)(
          ...
          props.state.engine.isVr && (0, _componentConfig.shouldRenderComponent)(props.config, _vrStereoToggle.VrStereoToggleControl.displayName) ? (0, _preact.h)(_vrStereoToggle.VrStereoToggleControl, { player: props.player }) : undefined,
...
var PrePlaybackPlayOverlay = (_dec = (0, _preactRedux.connect)(mapStateToProps, (0, _bindActions.bindActions)(Object.assign({}, _shell.actions, _loading.actions))), _dec(_class = function (_BaseComponent) {
  ...
  _createClass(PrePlaybackPlayOverlay, [{
    ...
    key: 'componentWillUnmount',
    value: function componentWillUnmount() {
      _get(PrePlaybackPlayOverlay.prototype.__proto__ || Object.getPrototypeOf(PrePlaybackPlayOverlay.prototype), 'componentWillUnmount', this).call(this);
    ...
    value: function componentDidMount() {
      ...
      this.eventManager.listen(this.player, this.player.Event.PLAY, function () {
    ...
    value: function render(props) {
      ...
      return (0, _preact.h)(
        'div',
        { className: rootClass.join(' '), style: rootStyle, onMouseOver: function onMouseOver(e) {
...
var _seekbar2 = __webpack_require__(37);
...
var _timeFormat = __webpack_require__(38);
...
var SeekBarControl = (_dec = (0, _preactRedux.connect)(mapStateToProps, (0, _bindActions.bindActions)(_shell.actions)), _dec(_class = function (_Component) {
  ...
  _createClass(SeekBarControl, [{
    ...
    value: function renderFramePreview() {
      ...
      return (0, _preact.h)(
        'div',
        { className: _style2.default.framePreview, style: this._getFramePreviewStyle(), ref: function ref(c) {
            return _this3._framePreviewElement = c;
          } },
        (0, _preact.h)('div', { className: _style2.default.framePreviewImg, style: this._getFramePreviewImgStyle() })
      );
    }
    ...
    value: function renderTimeBubble() {
      ...
      return (0, _preact.h)(
        'div',
        { className: _style2.default.timePreview, style: timeBubbleStyle, ref: function ref(c) {
...
var _smartContainer = __webpack_require__(41);

var _smartContainerItem = __webpack_require__(62);
...
var SettingsControl = (_dec = (0, _preactRedux.connect)(mapStateToProps, (0, _bindActions.bindActions)(_settings.actions)), _dec(_class = function (_BaseComponent) {
  ...
  _createClass(SettingsControl, [{
    ...
    value: function componentDidMount() {
      ...
      this.eventManager.listen(document, 'click', function (e) {
    ...
    value: function render(props) {
      ...
      var speedOptions = this.player.playbackRates.reduce(function (acc, speed) {
        ...
        if (speed === _this3.player.playbackRate) {
      ...
      var qualityOptions = props.videoTracks.sort(function (a, b) {
        ...
        return {
          label: t.label,
          active: !_this3.player.isAdaptiveBitrateEnabled() && t.active,
          value: t
        };
      });
      ...
      return (0, _preact.h)(
        'div',
        { ref: function ref(c) {
            return _this3._controlSettingsElement = c;
          ...
          qualityOptions.length <= 1 ? '' : (0, _preact.h)(
            ...
            (0, _preact.h)(_smartContainerItem.SmartContainerItem, {
              ...
              onSelect: function onSelect(o) {
                return _this3.onQualityChange(o);
              }
            })
          ),
          props.isLive || speedOptions.length <= 1 ? '' : (0, _preact.h)(
            _preactI18n.Localizer,
            null,
            (0, _preact.h)(_smartContainerItem.SmartContainerItem, { icon: 'speed', label: (0, _preact.h)(_preactI18n.Text, { id: 'settings.speed' }), options: speedOptions, onSelect: function onSelect(o) {
                return _this3.onSpeedChange(o);
              } })
          )
        )
      );
...
var _preactPortal = __webpack_require__(42);
...
var DropDown = (_dec = (0, _preactRedux.connect)(mapStateToProps), _dec(_class = function (_Component) {
  ...
  _createClass(DropDown, [{
    ...
    value: function renderNativeSelect() {
      ...
      return (0, _preact.h)(_menu.Menu, { options: this.props.options, onSelect: function onSelect(o) {
    ...
    value: function render(props) {
      ...
      return props.isMobile ? this.renderNativeSelect() : (0, _preact.h)(
        'div',
        { className: this.state.dropMenuActive ? [_style2.default.dropdown, _style2.default.active].join(' ') : _style2.default.dropdown, ref: function ref(el) {
        ...
        !this.state.dropMenuActive ? undefined : (0, _preact.h)(_menu.Menu, { parentEl: this._el, options: props.options, onSelect: function onSelect(o) {
...
var Menu = (_dec = (0, _preactRedux.connect)(mapStateToProps), _dec(_class = function (_Component) {
  ...
  _createClass(Menu, [{
    ...
    value: function renderNativeSelect() {
      ...
      return (0, _preact.h)(
        'select',
        { className: this.props.hideSelect ? _style2.default.mobileHiddenSelect : '', onChange: function onChange(e) {
...
var _cvaaOverlay = __webpack_require__(64);
  ...
  _createClass(LanguageControl, [{
    ...
    value: function renderAll(audioOptions, textOptions) {
      ...
      return (0, _preact.h)(
        'div',
        { ref: function ref(c) {
            return _this3._controlLanguageElement = c;
        ...
        !this.state.smartContainerOpen || this.state.cvaaOverlay ? undefined : (0, _preact.h)(
          ...
          audioOptions.length <= 1 ? undefined : (0, _preact.h)(
            _preactI18n.Localizer,
            null,
            (0, _preact.h)(_smartContainerItem.SmartContainerItem, {
              icon: 'audio',
              ...
              onSelect: function onSelect(audioTrack) {
                return _this3.onAudioChange(audioTrack);
              }
            })
          ),
          textOptions.length <= 1 ? undefined : (0, _preact.h)(
            _preactI18n.Localizer,
            null,
            (0, _preact.h)(_smartContainerItem.SmartContainerItem, {
              icon: 'captions',
              ...
              onSelect: function onSelect(textTrack) {
                return _this3.onCaptionsChange(textTrack);
              }
            })
          ),
          textOptions.length <= 1 ? undefined : (0, _preact.h)(
        ...
        this.state.cvaaOverlay ? (0, _preact.h)(
          ...
          { into: '#overlay-portal', ref: function ref(_ref) {
              return _this3._portal = _ref;
            } },
          (0, _preact.h)(_cvaaOverlay.CVAAOverlay, {
            player: this.player,
            onClose: function onClose() {
              _this3.toggleCVAAOverlay();
              _this3.onControlButtonClick();
            }
          })
    ...
    value: function renderMainState() {
      ...
      return (0, _preact.h)(
        ...
        !this.isAdvancedStyleApplied() ? (0, _preact.h)(
          ...
          (0, _preact.h)(
            'div',
            { tabIndex: '0', className: [_style2.default.sample, _style2.default.custom].join(' '), style: this.state.customTextStyle.toCSS() },
            (0, _preact.h)(
              'span',
              null,
              'Custom captions'
...
"use strict";
throw new Error("Module build failed: SyntaxError: Unexpected token (37:0)\n\n\u001b[0m \u001b[90m 35 | \u001b[39m\u001b[36mclass\u001b[39m \u001b[33mFullscreenControl\u001b[39m \u001b[36mextends\u001b[39m \u001b[33mBaseComponent\u001b[39m {\n \u001b[90m 36 | \u001b[39m  _targetDiv\u001b[33m:\u001b[39m \u001b[33m?\u001b[39m\u001b[33mHTMLElement\u001b[39m\u001b[33m;\u001b[39m\n\u001b[31m\u001b[1m>\u001b[22m\u001b[39m\u001b[90m 37 | \u001b[39m\u001b[33m<<\u001b[39m\u001b[33m<<\u001b[39m\u001b[33m<<\u001b[39m\u001b[33m<\u001b[39m \u001b[33mHEAD\u001b[39m\n \u001b[90m    | \u001b[39m\u001b[31m\u001b[1m^\u001b[22m\u001b[39m\n \u001b[90m 38 | \u001b[39m  fullscreenChangeHandler\u001b[33m:\u001b[39m \u001b[33mFunction\u001b[39m\u001b[33m;\u001b[39m\n \u001b[90m 39 | \u001b[39m  _prevFullscreenState\u001b[33m:\u001b[39m boolean\u001b[33m;\u001b[39m\n \u001b[90m 40 | \u001b[39m\u001b[33m===\u001b[39m\u001b[33m===\u001b[39m\u001b[33m=\u001b[39m\u001b[0m\n");
...
var _timeDisplay = __webpack_require__(46);
    ...
    value: function render(props) {
      ...
      return (0, _preact.h)(
        ...
        { tabIndex: '0', 'aria-label': 'Unmute',
          ...
          onKeyDown: function onKeyDown(e) {
            return _this3._keyDownHandler(e);
          } },
        (0, _preact.h)(
          'a',
...
var _timeDisplayAdsContainer = __webpack_require__(67);

var _adSkip = __webpack_require__(68);

var _adLearnMore = __webpack_require__(69);

var _topBar = __webpack_require__(70);
...
var _errorOverlay = __webpack_require__(71);
      ...
      if (sessionId) {
        return (0, _preact.h)(
          ...
          (0, _preact.h)(
            ...
            (0, _preact.h)(
              'a',
              { className: copyUrlClasses, onClick: function onClick() {
          ...
          (0, _preact.h)(
            ...
            (0, _preact.h)(
              ...
              (0, _preact.h)(
                ...
                (0, _preact.h)(
                  'svg',
                  { width: '124', height: '110', viewBox: '0 0 124 110', xmlns: 'http://www.w3.org/2000/svg', xmlnsXlink: 'http://www.w3.org/1999/xlink' },
                  (0, _preact.h)(
                    'defs',
                    null,
                    (0, _preact.h)('polygon', {
...
var _seekbarLivePlaybackContainer = __webpack_require__(72);
...
var _liveTag = __webpack_require__(73);
  ...
  return (0, _preact.h)(
    ...
    (0, _preact.h)(
      ...
      (0, _preact.h)(
        _bottomBar.BottomBar,
        null,
        (0, _preact.h)(_seekbarLivePlaybackContainer.SeekBarLivePlaybackContainer, { showFramePreview: true, showTimeBubble: true, player: props.player, playerContainer: props.playerContainer }),
        (0, _preact.h)(
          'div',
          { className: _style2.default.leftControls },
          (0, _preact.h)(_playPause.PlayPauseControl, { player: props.player }),
...
var _cvaa2 = __webpack_require__(19);

var _cvaa = _interopRequireWildcard(_cvaa2);

var _engine2 = __webpack_require__(12);
...
var _overlayAction2 = __webpack_require__(20);
...
var _share2 = __webpack_require__(33);
...
var _seekbar = __webpack_require__(37);
...
var _share = __webpack_require__(154);
...
var _shareOverlay = __webpack_require__(74);
...
var _watermark = __webpack_require__(159);
...
var _share = __webpack_require__(155);
