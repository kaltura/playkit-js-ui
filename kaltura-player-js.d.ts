...
export declare interface KPUIComponent extends KPUIAddComponent, KPUIRemoveComponent {
}

export declare interface KPUIComponentOptions {
    label: string;
...
export declare interface KPUIRemoveComponent {
    /** @deprecated Use area instead. */
    container?: string;
