...
const actions_3: {
    ...
    updateAdIsBumper: (adIsBumper: boolean) => {
        type: string;
        adIsBumper: boolean;
    };
    updateAdContentType: (adContentType: string) => {
        type: string;
    ...
    updateCastSession: (castSession: any) => {
        type: string;
        castSession: any;
    };
...
const actions_7: {
    ...
    updateSeekbarClientRect: (clientRect: any) => {
        type: string;
        clientRect: any;
    };
    ...
    updateVirtualTime: (virtualTime: number) => {
        type: string;
        virtualTime: number;
    };
    ...
    updateSegmentEndTime: (id: string, endTime: number) => {
        type: string;
        id: string;
        endTime: number;
    };
    updateSeekbarSegments: (segments: any[]) => {
        type: string;
        segments: any[];
    };
};
...
const actions_9: {
    ...
    updateIsSmallSize: (isSmallSize: boolean) => {
        type: string;
        isSmallSize: boolean;
    };
    updateGuiClientRect: (guiClientRect: any) => {
        type: string;
        guiClientRect: any;
    };
    updatePlayerClientRect: (playerClientRect: any) => {
        type: string;
        playerClientRect: any;
    };
    updateVideoClientRect: (videoClientRect: any) => {
        type: string;
        videoClientRect: any;
    };
    ...
    updateActivePresetName: (activePresetName: string) => {
        type: string;
    ...
    updatePresetSettings: (presetSettings: PresetSettings) => {
        type: string;
...
// src/reducers/shell.ts:289:3 - (ae-forgotten-export) The symbol "PresetSettings" needs to be exported by the entry point index.d.ts
// src/reducers/shell.ts:293:3 - (ae-forgotten-export) The symbol "LayoutStyles" needs to be exported by the entry point index.d.ts
